"""Cleaning, CamemBERT sentiment and K-means clustering - Instagram (TFE Cryptobel, 2025).
...
print("📂 Chargement des données Instagram...")
conn = sqlite3.connect(os.environ.get("INSTAGRAM_DB", "data/sample/instagram_sample.db"))
...
df_comments["text_clean"] = df_comments["text"].apply(nettoyer_texte_crypto)
